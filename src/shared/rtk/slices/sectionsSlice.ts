...
import { ANALYTICS_API_ENDPOINTS } from '@/shared/enums/endpoints/analytics.enum'

export const fetchAllAnalyticsData = createAsyncThunk('uiData/uiDataSlice', async (currentSection: string) => {
