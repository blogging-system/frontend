			...
			<nav className={styles.navbar}>
				...
				<ul className={styles.navbar_items}>
					<li className={styles.navbar_item}>
						<Link className={styles.navbar_item_link} href="/dashboard/posts/home">
							Posts
						</Link>
					</li>
					<li className={styles.navbar_item}>
						<Link className={styles.navbar_item_link} href="/dashboard/series/home">
							Series
						</Link>
					</li>
					<li className={styles.navbar_item}>
						<Link className={styles.navbar_item_link} href="/dashboard/walkthroughs/home">
							Walkthroughs
						</Link>
					</li>
				</ul>
